...
namespace Gnu.MP
{
    ...
    public class Real : IComparable<Real>, IComparable, ICloneable
    {
        ...
        [DllImport("gmp", EntryPoint = "__gmpf_init", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_init(ref mpf_t ptr);

        [DllImport("gmp", EntryPoint = "__gmpf_init2", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_init2(ref mpf_t ptr, uint prec);

        [DllImport("gmp", EntryPoint = "__gmpf_clear", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_clear(ref mpf_t ptr);

        [DllImport("gmp", EntryPoint = "__gmpf_set_default_prec", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_set_default_prec(uint prec);

        [DllImport("gmp", EntryPoint = "__gmpf_get_default_prec", CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mpf_get_default_prec();

        [DllImport("gmp", EntryPoint = "__gmpf_get_prec", CallingConvention = CallingConvention.Cdecl)]
        private static extern uint mpf_get_prec(ref mpf_t ptr);

        [DllImport("gmp", EntryPoint = "__gmpf_set_prec", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_set_prec(ref mpf_t ptr, uint prec);

        [DllImport("gmp", EntryPoint = "__gmpf_set", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_set(ref mpf_t rop, ref mpf_t op);

        [DllImport("gmp", EntryPoint = "__gmpf_set_ui", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_set_ui(ref mpf_t rop, uint op);

        [DllImport("gmp", EntryPoint = "__gmpf_set_si", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_set_si(ref mpf_t rop, int op);

        [DllImport("gmp", EntryPoint = "__gmpf_set_d", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_set_d(ref mpf_t rop, double op);

        [DllImport("gmp", EntryPoint = "__gmpf_set_z", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_set_z(ref mpf_t rop, ref mpz_t op);

        [DllImport("gmp", EntryPoint = "__gmpf_set_q", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_set_q(ref mpf_t rop, ref mpq_t op);

        [DllImport("gmp", EntryPoint = "__gmpf_set_str", CallingConvention = CallingConvention.Cdecl)]
        private static extern int mpf_set_str(ref mpf_t rop, IntPtr s, int sbase);

        [DllImport("gmp", EntryPoint = "__gmpf_swap", CallingConvention = CallingConvention.Cdecl)]
        private static extern int mpf_swap(ref mpf_t rop1, ref mpf_t rop2);

        [DllImport("gmp", EntryPoint = "__gmpf_init_set", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_init_set(ref mpf_t rop, ref mpf_t op);

        [DllImport("gmp", EntryPoint = "__gmpf_init_set_ui", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_init_set_ui(ref mpf_t rop, uint op);

        [DllImport("gmp", EntryPoint = "__gmpf_init_set_si", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_init_set_si(ref mpf_t rop, int op);

        [DllImport("gmp", EntryPoint = "__gmpf_init_set_d", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_init_set_d(ref mpf_t rop, double op);

        [DllImport("gmp", EntryPoint = "__gmpf_init_set_str", CallingConvention = CallingConvention.Cdecl)]
        private static extern int mpf_init_set_str(ref mpf_t rop, IntPtr s, int sbase);

        [DllImport("gmp", EntryPoint = "__gmpf_get_d", CallingConvention = CallingConvention.Cdecl)]
        private static extern double mpf_get_d(ref mpf_t op);

        [DllImport("gmp", EntryPoint = "__gmpf_get_si", CallingConvention = CallingConvention.Cdecl)]
        private static extern int mpf_get_si(ref mpf_t op);

        [DllImport("gmp", EntryPoint = "__gmpf_get_str", CallingConvention = CallingConvention.Cdecl)]
        private static extern IntPtr mpf_get_str(IntPtr s, ref int expptr, int sbase, int ndigits, ref mpf_t op);

        [DllImport("gmp", EntryPoint = "__gmpf_add", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_add(ref mpf_t rop, ref mpf_t op1, ref mpf_t op2);

        [DllImport("gmp", EntryPoint = "__gmpf_add_ui", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_add_ui(ref mpf_t rop, ref mpf_t op1, uint op2);

        [DllImport("gmp", EntryPoint = "__gmpf_sub", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_sub(ref mpf_t rop, ref mpf_t op1, ref mpf_t op2);

        [DllImport("gmp", EntryPoint = "__gmpf_sub_ui", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_sub_ui(ref mpf_t rop, ref mpf_t op1, uint op2);

        [DllImport("gmp", EntryPoint = "__gmpf_ui_sub", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_ui_sub(ref mpf_t rop, uint op1, ref mpf_t op2);

        [DllImport("gmp", EntryPoint = "__gmpf_mul", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_mul(ref mpf_t rop, ref mpf_t op1, ref mpf_t op2);

        [DllImport("gmp", EntryPoint = "__gmpf_mul_ui", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_mul_ui(ref mpf_t rop, ref mpf_t op1, uint op2);

        [DllImport("gmp", EntryPoint = "__gmpf_div", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_div(ref mpf_t rop, ref mpf_t op1, ref mpf_t op2);

        [DllImport("gmp", EntryPoint = "__gmpf_div_ui", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_div_ui(ref mpf_t rop, ref mpf_t op1, uint op2);

        [DllImport("gmp", EntryPoint = "__gmpf_ui_div", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_ui_div(ref mpf_t rop, uint op1, ref mpf_t op2);

        [DllImport("gmp", EntryPoint = "__gmpf_cmp", CallingConvention = CallingConvention.Cdecl)]
        private static extern int mpf_cmp(ref mpf_t op1, ref mpf_t op2);

        [DllImport("gmp", EntryPoint = "__gmpf_cmp_d", CallingConvention = CallingConvention.Cdecl)]
        private static extern int mpf_cmp_d(ref mpf_t op1, double op2);

        [DllImport("gmp", EntryPoint = "__gmpf_cmp_si", CallingConvention = CallingConvention.Cdecl)]
        private static extern int mpf_cmp_si(ref mpf_t op1, int op2);

        [DllImport("gmp", EntryPoint = "__gmpf_cmp_ui", CallingConvention = CallingConvention.Cdecl)]
        private static extern int mpf_cmp_ui(ref mpf_t op1, uint op2);

        [DllImport("gmp", EntryPoint = "__gmpf_ceil", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_ceil(ref mpf_t rop, ref mpf_t op);

        [DllImport("gmp", EntryPoint = "__gmpf_floor", CallingConvention = CallingConvention.Cdecl)]
        private static extern int mpf_floor(ref mpf_t rop, ref mpf_t op);

        [DllImport("gmp", EntryPoint = "__gmpf_trunc", CallingConvention = CallingConvention.Cdecl)]
        private static extern int mpf_trunc(ref mpf_t rop, ref mpf_t op);

        [DllImport("gmp", EntryPoint = "__gmpf_integer_p", CallingConvention = CallingConvention.Cdecl)]
        private static extern int mpf_integer_p(ref mpf_t op);

        [DllImport("gmp", EntryPoint = "__gmpf_sqrt", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_sqrt(ref mpf_t rop, ref mpf_t op);

        [DllImport("gmp", EntryPoint = "__gmpf_sqrt_ui", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_sqrt_ui(ref mpf_t rop, uint op);

        [DllImport("gmp", EntryPoint = "__gmpf_pow_ui", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_pow_ui(ref mpf_t rop, ref mpf_t op1, uint op2);

        [DllImport("gmp", EntryPoint = "__gmpf_abs", CallingConvention = CallingConvention.Cdecl)]
        private static extern void mpf_abs(ref mpf_t rop, ref mpf_t op);

        [DllImport("gmp", EntryPoint = "__gmpf_neg", CallingConvention = CallingConvention.Cdecl)]
